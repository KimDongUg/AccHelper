...
+ '    .body { padding: 34px 40px 40px; flex: 1; display: flex; flex-direction: column; justify-content: space-between; }\n'
+ '    .intro-box {\n      background: linear-gradient(135deg, #f1f8e9, #e8f5e9);\n      border: 1.5px solid #a5d6a7; border-radius: 14px;\n      padding: 26px 28px; display: flex; gap: 20px;\n      align-items: flex-start; margin-bottom: 32px;\n    }\n'
...
+ '    .features-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 18px; margin-bottom: 34px; }\n'
...
+ '    .qr-wrap img { width: 140px; height: 140px; display: block; border-radius: 6px; }\n'
