...
+ '    .notice-row .icon { font-size: 23px; }\n'
+ '    .notice-row p { font-size: 15px; color: #5d4037; line-height: 1.6; }\n'
...
+ '    .footer-logo { font-size: 18px; font-weight: 800; color: #2e7d32; }\n'
+ '    .footer-logo span { color: #81c784; }\n'
+ '    .footer-divider { width: 1px; height: 14px; background: #ccc; margin: 0 10px; }\n'
+ '    .footer-info { font-size: 14px; color: #888; }\n'
+ '    .footer-right { font-size: 14px; color: #aaa; text-align: right; line-height: 1.6; }\n'
